...
const Contact = () => {
      ...
      .send(
       'service_k4f35mt',
        'template_md081g9',
        {
          ...
          to_email: "sanjaiprakash075@gmail.com",
  ...
  return (
    <div
      className={`xl:mt-12 flex xl:flex-row flex-col-reverse items-center gap-10 overflow-hidden xl:ml-16`}
    >
      <motion.div
      ...
      <motion.div
        ...
        className='xl:flex-1   md:h-[450px] h-[350px]  md:w-[50%] '
      >
        <EarthCanvas />
      </motion.div>
    </div>
